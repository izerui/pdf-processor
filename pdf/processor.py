...
from fitz import fitz, Font, Document, Rect
...
from support import a4_width, a4_height, header_height, logger, get_url_content_retry, logged, read_bytes_from_file, \
    read_temp_file_instant, get_text_rotation_from_dir
...
class Processor(object):
    ...
    def wrap_target_doc_with_source_annots(self, rotations: list[float], source_file_doc, target_item_doc):
        ...
        for index, page in enumerate(source_file_doc):
            ...
            print(rotations[index], is_h_scale_factor, scale_factor * page.cropbox.width, scale_factor * page.cropbox.height)
